...
$(window).load(function(){
		...
		//&sortlist=%27bmaAuxHierarquia:Ascending,bmaNomeComp:Ascending%27
		...
		var searchUrl = query + searchProps + pag //+ "&QueryTemplatePropertiesUrl=%27spfile://webroot/queryparametertemplate.xml%27";
		//searchUrl = "querytext='*'"+ "&QueryTemplatePropertiesUrl='spfile://webroot/queryparametertemplate.xml'";
...
function SearchComplete(data) {
	...
	if (rowCount == 0) {
	    ...
	    $.each(results, function (index, result) {
			...
			var ramal = result.Cells.results[4].Value;
			var htmlFrente = "";
			var htmlTras = "";
			var img = "/Style Library/Images/profile.jpg";
			var nome = result.Cells.results[7].Value;
			var cargo = result.Cells.results[8].Value +" Setor"+result.Cells.results[5].Value;
			var celular = result.Cells.results[9].Value;
			var email = result.Cells.results[10].Value;
			var imagem = result.Cells.results[11].Value;
			var id = result.Cells.results[12].Value;
...
function carregar(){  
	 ...
	 GetListItems('Escritorios',"",function(data){RenderFiltro(data,'Escritorios')} ,function(){alert("Erro")},"")
	 GetListItems('Setor',"",function(data){RenderFiltro(data,'Setor')} ,function(){alert("Erro")},"")
	}	
