...
$(window).load(function() {
    ...
    var searchUrl = query + searchProps + pag ;
...
//Nao e recomendado variaveis globais
Escritorios = [];
Setor = [];
...
function carregar() {
    ...
    GetListItems('Escritorios', "", function(data) {
        RenderFiltro(data, 'Escritorios')
    }, function() {
        alert("Erro")
    }, "")
    GetListItems('Setor', "", function(data) {
        RenderFiltro(data, 'Setor')
    }, function() {
        alert("Erro")
    }, "")
}
